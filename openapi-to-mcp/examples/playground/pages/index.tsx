...
export default function Home() {
  ...
  const [currentTab, setCurrentTab] = useState("prompt"); // 'prompt', 'execute', 'mcp', 'prompt-execute'
  ...
  const handleModeChange = (mode: "demo" | "api") => {
    if (mode === "demo") {
      setIsDemoMode(true);
          ...
          <div className="md:w-1/2">
            ...
            <div className="mb-4 flex border-b">
              ...
              <button
                ...
                onClick={() => setCurrentTab("prompt-execute")}
              >
                Prompt → Execute
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading || (!isDemoMode && !apiKey)}
                className="w-full py-2 px-4 bg-blue-600 text-white font-medium rounded-md shadow-sm disabled:bg-blue-300"
              >
