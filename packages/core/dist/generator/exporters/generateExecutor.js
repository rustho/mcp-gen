...
exports.generateExecutor = generateExecutor;
 ...
 */
function generateExecutor(mcpJson, outputPath, apiBaseUrl) {
    const executorCode = `
/**
 ...
 */
function generateSampleParams(action) {
    if (!action.params)
        return {};
    const result = {};
...
//# sourceMappingURL=generateExecutor.js.map