...
function createExecutorInstance(mcpJson, apiBaseUrl) {
    return {
        ...
        async execute(actionName, params = {}) {
            ...
            const action = (_a = mcpJson.actions) === null || _a === void 0 ? void 0 : _a.find((a) => a.action === actionName);
            if (!action) {
...
function getSampleValueForProperty(property) {
    ...
    switch ((_a = property.type) === null || _a === void 0 ? void 0 : _a.toLowerCase()) {
        case "string":
...
${(_a = mcpJson.actions) === null || _a === void 0 ? void 0 : _a.map((action) => `- ${action.action}: ${action.description || `${action.method} ${action.path}`}`).join("\n")}
...
function generateFunctionDefinitions(mcpJson) {
    var _a;
    const functions = ((_a = mcpJson.actions) === null || _a === void 0 ? void 0 : _a.map((action) => {
        const parameters = {
            type: "object",
            properties: {},
            required: [],
